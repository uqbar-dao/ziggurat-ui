...
import { FaRegPlusSquare, FaRegMinusSquare, FaDownload, FaTrash, FaUpload, FaChevronDown, FaChevronRight } from 'react-icons/fa';
...
export const GallAppDirectory = ({ project }: GallAppDirectoryProps) => {
  ...
  const { title, folders, expanded } = project
